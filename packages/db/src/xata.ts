...
const tables = [
  {
    ...
    revLinks: [
      ...
      { column: "user", table: "songrequests_submissions" },
    ],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "artists", type: "multiple" },
      { name: "preview_url", type: "text" },
      { name: "title", type: "string" },
      { name: "permalink", type: "text" },
      { name: "thumbnail_url", type: "string" },
      { name: "thumbnail_height", type: "int" },
      { name: "thumbnail_width", type: "int" },
      { name: "lastSubmittedAt", type: "datetime" },
    ],
    revLinks: [{ column: "songrequest", table: "songrequests_submissions" }],
  },
  {
    name: "songrequests_submissions",
    columns: [
      { name: "songrequest", type: "link", link: { table: "songrequests" } },
      { name: "user", type: "link", link: { table: "nextauth_users" } },
      { name: "songRequestId", type: "string" },
    ],
  },
] as const;
...
export type Songrequests = InferredTypes["songrequests"];
export type SongrequestsRecord = Songrequests & XataRecord;

export type SongrequestsSubmissions = InferredTypes["songrequests_submissions"];
export type SongrequestsSubmissionsRecord = SongrequestsSubmissions &
  XataRecord;
...
export type DatabaseSchema = {
  ...
  songrequests_submissions: SongrequestsSubmissionsRecord;
};

const DatabaseClient = buildClient();

const defaultOptions = {
  databaseURL: "https://lemasc-da3ikp.us-west-2.xata.sh/db/satitpm65-station",
};
